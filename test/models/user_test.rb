...
class UserTest < ActiveSupport::TestCase
  def setup
    @user = User.new(name: "Carlos Stevenson", email: "carlos@stevenson.com", password: "foobar", password_confirmation: "foobar")
  end
  ...
  test "email validation should accept valid addresses" do
    valid_addresses = %w[user@example.com foo@poo.com gnarly@la.da.org first.last@jj.jp alice+bob@baz.cn]
